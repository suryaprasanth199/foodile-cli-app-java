...
1. **Clone the repository**
   ```bash
   git clone https://github.com/suryaprasanth199/foodie-cli-java.git
    ```
...
- E-mail: prasanthroyal9959@gmail.com
- GitHub: [Your GitHub Profile](https://github.com/suryaprasanth199)